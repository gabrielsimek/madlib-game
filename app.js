...
function sync(noun1Input, noun2Input, adjective1Input, verb1Input, adjective2Input, verb2Input){
    ...
    noun2Input = document.getElementById('noun2-output');
    adjective1Input = document.getElementById('adjective1-output');
    verb1Input = document.getElementById('verb1-output');
    adjective2Input = document.getElementById('adjective2-output');
    verb2Input = document.getElementById('verb2-output');
